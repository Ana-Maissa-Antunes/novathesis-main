...
\gls{GIS} can be employed for the management of \gls{CH} resources, providing efficient handling of \gls{CH} data. A key application of GIS is the documentation of \gls{CH} sites, including, for example, georeferenced data from points of interest within archaeological sites. This approach enhances the preservation of \gls{CH} findings while allowing the associated data to be accessed and updated as needed.
