...
Multi-image photogrammetry is a technique that combines large groups of images.
...
\begin{figure}[h!]
    ...
    \caption{Fundamental concepts of \texttt{ISO 21127} ~\cite{doerr2007cidoc}} %%~\cite{doerr2003cidoc}}
    \label{fig:cidoc}
\end{figure}
\FloatBarrier
