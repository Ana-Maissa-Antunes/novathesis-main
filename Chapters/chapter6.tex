...
User testing was conducted in person with several groups of participants. \gls{VICARTE} experts, archaeologists (including the director of the Roman Ruins of Troia), and standard users. This combination enabled comprehensive feedback.
...
\begin{enumerate}[label=T\arabic* --]
    ...
    \item Grabbing and manipulating artefact
...
\begin{enumerate}[label=S\arabic* --]
    ...
    \item I clearly distinguish between the artefact's original and restored state.
    \item The information provided helped me better understand the artefact.
    \item The experience contributed to a better understanding of the site.
    \item The experience helped me better understand the presented artefacts.
