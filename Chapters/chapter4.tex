...
This chapter presents the overall design and conceptualization of the system developed. It begins in Section \ref{sec:requirements} with a description of the implemented system requirements, followed by Section \ref{sec:tools} that introduces the technologies and tools adopted.
...
This section describes the implemented requirements of this dissertation, categorized into the following areas: Interactive Map, \gls{3D} Model Interaction, and Virtual Reality (\gls{VR}) environment.
...
\begin{itemize}
    \item \textbf{Artefact Interaction:} Allows users to virtually manipulate the glass artefact models.
...
This tool was used to create an approximation of the original texture of the glass object. Originally transparent, translucent.
...
The database consists of 10 tables that ensure the significant data of excavation and objects are stored. %All artefacts data, excavation details, and objects intervention data were stored within this repository.
