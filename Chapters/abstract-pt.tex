...
Este projeto estuda vidros luxuosos e únicos do período romano, encontrados recentemente num luxuoso mausoléu descoberto em Tróia, Setúbal.
...
e garantir a continuidade futurado seu desenvolvimento, com grande potencial para novos progressos.
...
Esta plataforma deverá, no seu estado final, incluir um mapa interativo da Península Troiana, um repositório contendo dados sobre as escavações realizadas em Tróia e uma experiência de realidade virtual, que permitirá uma imersão virtual a um objeto físico existente. 
Por fim, estes elementos serão integrados num ambiente digital sob a forma de modelos 3D.
Estas tecnologias irão enriquecer a experiência dos visitantes das ruínas de Tróia, proporcionando-lhes a oportunidade de interagir com alguns dos artefactos mais raros do Império Romano. 
